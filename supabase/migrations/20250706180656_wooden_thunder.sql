...
INSERT INTO users (nom, prenom, email, telephone, mot_de_passe, role, actif, date_creation, tentatives_connexion) VALUES
('Admin', 'Super', 'admin@sidra.tn', '+21612345678', '$2a$10$N.zmdr9k7uOLQvQHbh8biOehGklRLvdQBYsQ5UgMJmFQJIrLMjvH2', 'SUPER_ADMIN', true, NOW(), 0)
ON CONFLICT (email) DO NOTHING;

-- Insertion d'un admin structure
-- Mot de passe: "admin123" (hashé avec BCrypt)
