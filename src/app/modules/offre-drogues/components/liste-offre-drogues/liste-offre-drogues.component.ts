      ...
      <div class="page-header">
        <div class="header-content">
          ...
          <p class="page-description">
            {{ isExterne() ? 'Gérer vos saisies d\'indicateurs' : 'Consulter les indicateurs saisis par les structures' }}
          </p>
        </div>
        <button 
          *ngIf="isExterne()"
...
export class ListeOffreDroguesComponent implements OnInit {
  ...
  private loadData(): void {
    ...
    this.offreDroguesService.getOffresDrogues().subscribe({
      next: (data) => {
        this.data = data;
        this.filterData();
  ...
  deleteItem(): void {
    ...
    this.offreDroguesService.deleteOffreDrogues(this.itemToDelete.id).subscribe({
      next: () => {
